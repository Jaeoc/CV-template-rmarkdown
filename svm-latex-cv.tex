...
%add pckages or kableExtra tables don't work [Anton]
\usepackage{float}
\usepackage{array}
\usepackage{booktabs}
\usepackage{tabu}
\usepackage{colortbl} %used to remove colors of lines in kable
\usepackage{titlesec} %control lines under sections

%line under each header section [Anton]
\titleformat{\section}
